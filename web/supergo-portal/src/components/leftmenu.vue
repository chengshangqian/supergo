						...
						<div class="item bo">
							...
							<div class="item-list clearfix">
								<div class="subitem">
									<dl class="fore1">
										<dt><a href="">电子书</a></dt>
										<dd><em><a href="//search.supergo.com/search.html?cid=3">婚恋/两性</a></em><em><a href="">文学</a></em><em><a href="">经管</a></em><em><a href="">畅读VIP</a></em></dd>
									</dl>
									<dl class="fore2">
										<dt><a href="">数字音乐</a></dt>
      ...
      <el-carousel-item v-for="item in bannerImg" :key="item">
        <h3><img :src=item></h3>
				...
				<div class="yui3-u Right">
					<div class="news">
						<h4><em class="fl">Super购快报</em><span class="fr tip">更多 ></span></h4>
					...
					<div class="ads">
						<img src="//static.supergo.com/img/ad1.png" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				<li class="yui3-u-1-6  clock">
					<div class="time">
						<img src="//static.supergo.com/img/clock.png" />
						<h3>今日推荐</h3>
					</div>
				</li>
				<li class="yui3-u-5-24">
					<a href="//search.supergo.com/search.html?cid=3" target="_blank"><img src="//static.supergo.com/img/today01.png" /></a>
				</li>
				<li class="yui3-u-5-24">
					<a href="//search.supergo.com/search.html?cid=3" target="_blank"><img src="//static.supergo.com/img/today02.png" /></a>
				</li>
				<li class="yui3-u-5-24">
					<a href="//search.supergo.com/search.html?cid=3" target="_blank"><img src="//static.supergo.com/img/today03.png" /></a>
				</li>
				<li class="yui3-u-5-24">
					<a href="//search.supergo.com/search.html?cid=3" target="_blank"><img src="//static.supergo.com/img/today04.png" /></a>
				</li>
			</ul>
		</div>
	</div>
				...
				<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="//search.supergo.com/search.html?cid=3" class="pic"><img src="//static.supergo.com/img/like_01.png" alt="" /></a>
								<div class="like-text">
					...
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="//search.supergo.com/search.html?cid=3" class="pic"><img src="//static.supergo.com/img/like_02.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="//search.supergo.com/search.html?cid=3" class="pic"><img src="//static.supergo.com/img/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="//search.supergo.com/search.html?cid=3" class="pic"><img src="//static.supergo.com/img/like_04.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="//search.supergo.com/search.html?cid=3" class="pic"><img src="//static.supergo.com/img/like_05.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="//search.supergo.com/search.html?cid=3" class="pic"><img src="//static.supergo.com/img/like_06.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
...
<div class="fun">
		<div class="py-container">
			<div class="title">
				<h3 class="fl">Super购.有趣区</h3>
			</div>
			<div class="clearfix yui3-g Interest">
				<span class="x-line"></span>
					<div class="yui3-u row-405 Interest-conver">
						<img src="//static.supergo.com/img/interest01.png" />
					</div>
				<div class="yui3-u row-225 Interest-conver-split">
							<h5>好东西</h5>
						<img src="//static.supergo.com/img/interest02.png" />
						<img src="//static.supergo.com/img/interest03.png" />
				</div>
				<div class="yui3-u row-405 Interest-conver-split blockgary">
							<h5>品牌街</h5>
							<div class="split-bt">
							<img src="//static.supergo.com/img/interest04.png" />
						</div>
							<div class="x-img fl">
							<img src="//static.supergo.com/img/interest05.png" />
						</div>
							<div class="x-img fl">
							<img src="//static.supergo.com/img/interest06.png" />
						</div>
				</div>
				<div class="yui3-u row-165 brandArea">
					<span class="brand-yline"></span>
					<ul class="yui3-g brand-list">
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand01.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand02.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand03.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand04.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand05.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand06.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand07.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand08.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand09.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="//static.supergo.com/img/brand10.png" /></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div id="tab1" class="tab-pane active">
					<div class="yui3-g Floor-1">
						<div class="yui3-u Left blockgary">
							...
							<img src="//static.supergo.com/img/floor-1-1.png" />
						</div>
        ...
        <h3><img :src=item></h3>
						...
						<div class="yui3-u row-220 split">
							...
							<div class="floor-conver-pit">
								<img src="//static.supergo.com/img/floor-1-2.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="//static.supergo.com/img/floor-1-3.png" />
							</div>
						</div>
						<div class="yui3-u row-218 split">
							<img src="//static.supergo.com/img/floor-1-4.png" />
						</div>
						<div class="yui3-u row-220 split">
							<span class="floor-x-line"></span>
							<div class="floor-conver-pit">
								<img src="//static.supergo.com/img/floor-1-5.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="//static.supergo.com/img/floor-1-6.png" />
							</div>
						</div>
					</div>
				</div>
...
<div class="brand">
		<div class="py-container">
			<ul class="Brand-list blockgary">
				<li class="Brand-item">
					<img src="//static.supergo.com/img/brand_21.png" />
				</li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_03.png" /></li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_05.png" /></li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_07.png" /></li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_09.png" /></li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_11.png" /></li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_13.png" /></li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_15.png" /></li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_17.png" /></li>
				<li class="Brand-item"><img src="//static.supergo.com/img/brand_19.png" /></li>
			</ul>
		</div>
	</div>
...
export default {
    ...
    data () {
        return {
            bannerImg:[
				'//static.supergo.com/img/banner1.jpg',
				'//static.supergo.com/img/banner2.jpg',
				'//static.supergo.com/img/banner3.jpg',
				'//static.supergo.com/img/banner4.jpg'	
			],
			goodsImg:[
				'//static.supergo.com/img/floor-1-b01.png',
				'//static.supergo.com/img/floor-1-b02.png',
				'//static.supergo.com/img/floor-1-b03.png',
			],
